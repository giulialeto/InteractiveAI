...
for d in *.json; do
    ...
    ./createPerimeterKube.sh  $perimeter $1
done

 ./addPerimeterToGroupKube.sh cabProcess Dispatcher $1
 ./addPerimeterToGroupKube.sh cabProcess Planner $1
 ./addPerimeterToGroupKube.sh cabProcess Supervisor $1
